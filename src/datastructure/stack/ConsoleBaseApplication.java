...
public class ConsoleBaseApplication {
	...
	public static void main(String args[]) {
		...
		do {
			...
			System.out.println("***Wel-come to Data-Structure Menu");

			System.out.println("01.Stack");
			System.out.println("02.Queue");
			System.out.println("03.LinkedList");
			System.out.println("04.ArrayList");
...
//						break;
			...
			System.out.println("Do you again want to use datastructures; Y/N ?");
			again = sc.next();
